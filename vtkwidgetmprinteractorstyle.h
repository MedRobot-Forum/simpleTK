...
#include "utility.h"
	...
	public:
		...
		vtkWidgetMPR* getWidget() const { return m_widget; }
		vtkAxisActor2D* getAxisActor2D() const { return m_axisActor; }
		vtkImageResliceToColors* getImageReslice() const { return m_imageReslice; }

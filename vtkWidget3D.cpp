...
//-----------------------------------------------------------------------------
void vtkWidget3D::initBoxWidget()
{
...
//-----------------------------------------------------------------------------
void vtkWidget3D::initBoxWidgetCallback()
{
...
//-----------------------------------------------------------------------------
void vtkWidget3D::initInteractorStyle()
{
	m_interactorStyle =
...
//-----------------------------------------------------------------------------
void vtkWidget3D::setVolumeMapperBlend() const
{
	m_mapper->SetBlendMode(vtkVolumeMapper::COMPOSITE_BLEND);
}

//-----------------------------------------------------------------------------
// std::tuple<int, int> vtkWidget3D::getWindowLevel() const
// {
...
//-----------------------------------------------------------------------------
void vtkWidget3D::setFilter(const QString& t_filePath)
{
// 	try
// 	{
// 		if (t_filePath == "MIP")
...
//-----------------------------------------------------------------------------
void vtkWidget3D::activateBoxWidget(const bool& t_flag)
{
	if (!m_boxWidget)
	{
		initBoxWidget();
...
//-----------------------------------------------------------------------------
void vtkWidget3D::updateFilter() const
{

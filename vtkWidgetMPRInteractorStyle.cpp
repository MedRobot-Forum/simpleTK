...
vtkStandardNewMacro(vtkWidgetMPRInteractorStyle);

void vtkWidgetMPRInteractorStyle::rescaleAxisActor()
{
	auto* const bounds =
...
//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::moveToSlice(const int& t_number)
{
	moveSlice(t_number - CurrentImageNumber);
}

//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnMouseMove()
{
	const auto x =
...
//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnMouseWheelForward()
{
	moveSlice(1);
}

//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnMouseWheelBackward()
{
	moveSlice(-1);
}

//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnLeftButtonDown()
{
	startAction(transformationType::windowLevel);
}

//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnLeftButtonUp()
{
	auto* const windows =
...
//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnRightButtonDown()
{
	startAction(transformationType::zoom);
}

//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnRightButtonUp()
{
	StopState();
...
//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnMiddleButtonDown()
{
	startAction(transformationType::pan);
}

//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::OnMiddleButtonUp()
{
	StopState();
...
//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::startAction(const transformationType& t_action)
{
...
//-----------------------------------------------------------------------------
void vtkWidgetMPRInteractorStyle::moveSlice(const int& t_delta)
{
	const int nextSlice =

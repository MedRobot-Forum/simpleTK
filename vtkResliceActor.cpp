...
vtkStandardNewMacro(vtkResliceActor);

void vtkResliceActor::createActor()
{
...
//-----------------------------------------------------------------------------
void vtkResliceActor::reset() const
{
...
//-----------------------------------------------------------------------------
void vtkResliceActor::setDisplaySize(const double* t_size)
{
...
//-----------------------------------------------------------------------------
void vtkResliceActor::setDisplayOriginPoint(const double* t_point)
{
...
//-----------------------------------------------------------------------------
void vtkResliceActor::setCenterPosition(const double* t_center)
{
...
//-----------------------------------------------------------------------------
void vtkResliceActor::createColors(double* t_color1, double* t_color2)
{
	m_colors[0] =

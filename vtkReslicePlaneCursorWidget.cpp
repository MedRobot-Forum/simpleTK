...
vtkStandardNewMacro(vtkReslicePlaneCursorWidget);
...
public:
	...
	int m_handleNumber = {};
	vtkReslicePlaneCursorWidget* m_resliceWidget = {};
};


vtkReslicePlaneCursorWidget::vtkReslicePlaneCursorWidget()
{
	initializeWidget();
}
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::initializeWidget()
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::SetEnabled(const int enabling)
{
	if (enabling) //----------------
	{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::CreateDefaultRepresentation()
{
	if (!WidgetRep)
	{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::leftMouseDownAction(vtkAbstractWidget* w)
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::moveMouse(vtkAbstractWidget* w)
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::leftMouseUpAction(vtkAbstractWidget* w)
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::rotateCursor(double t_angle) const
{
	dynamic_cast<vtkResliceWidgetRepresentation*>(WidgetRep)->rotate(t_angle);
}

//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::setPlane(int t_plane)
{
	m_plane = t_plane;
}

//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::SetCursor(int t_state)
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::setCursorPosition(double* t_position) const
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::setCursorCenterPosition(const double* t_position)
{
...
double* vtkReslicePlaneCursorWidget::getCursorCenterPosition()
{
	return m_cursorCenterPosition;
}

//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::startWidgetInteraction(int handleNum)
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::widgetInteraction(int handleNum)
{
...
//-----------------------------------------------------------------------------
void vtkReslicePlaneCursorWidget::endWidgetInteraction(int handleNum)
{

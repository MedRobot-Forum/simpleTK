...
//-----------------------------------------------------------------------------
void TransferFunction::setMaximumIntensityProjectionFunction(const int& t_windowCenter,
...
//-----------------------------------------------------------------------------
void TransferFunction::updateWindowLevel(const double& t_window, const double& t_level)
{
	m_window += t_window;
	m_level += t_level;
	if (m_colorFunction)
...
//-----------------------------------------------------------------------------
void TransferFunction::loadFilterFromFile(const QString& t_fileName)
{
...
//-----------------------------------------------------------------------------
void TransferFunction::extractColorFunctionInfo(const QJsonArray& t_array)
{
...
//-----------------------------------------------------------------------------
void TransferFunction::extractOpacityFunctionInfo(const QJsonArray& t_array)
{
